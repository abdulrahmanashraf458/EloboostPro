...
const CustomerSatisfactionChart: React.FC<CustomerSatisfactionChartProps> = ({ isLoading, timeRange }) => {
  return (
    <ChartContainer>
      <ChartHeader>
      ...
      <ChartContent>
        {isLoading ? (
          ...
          <div>
            {/* Here will be the customer satisfaction chart content */}
            <MockChart>
              <MockText>Customer Satisfaction Rate: 94.5%</MockText>
            </MockChart>
          </div>
        )}
      </ChartContent>
